                    ...
                    <div class="collapse navbar-collapse justify-content-between" id="navbarNavDropdown">
                        <ul class="navbar-nav">
                            <li class="nav-item d-flex align-items-center m-0">
                                <i class="bi bi-camera-reels-fill text-warning h2 my-0 me-1" aria-label="film icon"></i>
                        ...
                        <ul class="navbar-nav">
                            <li class="nav-item d-flex align-items-center me-3 my-2 my-lg-0">
                                ...
                                }" aria-label="rental terms page">Rental Terms</Link>
                            </li>
                            <li class="nav-item d-flex align-items-center me-3 my-2 my-lg-0">
                                <i class="bi bi-camera-reels text-white" aria-label="our film list icon"></i>
                                <Link :href="route('films')" class="nav-link p-1" :class="{
                                    'text-secondary': $page.url !== '/films',
                                    'text-white': $page.url === '/films',
                                }" aria-label="our film list page">Movies</Link>
                            </li>
